...
- [ ] Exact final 1.0.1 head passes the complete iOS simulator unit-test suite.
...
- [x] Failure to open the local SwiftData store produces a non-destructive recovery state rather than `fatalError`.
