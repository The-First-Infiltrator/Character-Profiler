...
GitHub Actions dynamically prepares an iPhone simulator, runs the complete unit-test suite, compiles an optimized simulator Release and separately compiles an unsigned optimized real-device iOS Release.
